...
7 main functions. `calculate_overall_customer_satisfaction`, `calculate_driver_effiency`, `analyse_driver_efficiency`, `calculate_driver_performance`, `calculate_driver_loyalty`, `calculate_payout`, `calculate_bonus` and `insert_analysis_row`
