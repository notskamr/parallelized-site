...
Drivers are paid with a base fee of Rs. 50, and an additional Rs. 10 per kilometer driven. Calculate the total paycheck for each driver. This will eventually be stored.
