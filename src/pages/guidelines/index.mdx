...
`calculate_overall_custom_satisfaction` should get the average ratings over all rides.
...
2. They are very slow in terms of speed across all rides (below 20km/h): "SLOW"
