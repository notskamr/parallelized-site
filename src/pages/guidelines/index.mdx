...
## Getting Started
Please clone this repository locally: https://github.com/parallelized/parallelized-starter. Your code should be available to see on GitHub so make sure to set up a repository for your submission!
...
Let's take a look at the below snippet from the table schematic for 'driver_analyses', which is the table which you will work with in this function.
```sql
...
## Scoring
Implementations are based on functionality and speed. You are graded with a 50% weightage toward successful implementations, a 50% weightage towards speedup over a naive staff implementation, and a 5% weightage towards tying it all together!
